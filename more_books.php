				...
				<div class="row">
					<div class="col-md-6 col-sm-12 col-xs-12">
						<div class="header-details">
							<h1><br>various kind of <br>books to <br>attract you<i class="fa fa-circle"></i></h1>
							<p>I have a part of everything that I have read.<br>-Therodore Roosevelt</p>
							<form action="#promotion-area" method="get">
							<a href="#promotion-area"><button class="btn btn-default">Scroll Down</button></a></form>
						</div>
					</div>
				</div>
			</div>
            ...
            <div class="container">
                ...
                <div class="row">
					<div class="col-sm-4 col-sm-12 col-xs-12">
						...
						<a href="./fictionBooks.php"><h4>more<span><i class="fa fa-long-arrow-right"></i></span></h4></a>
            ...
            <div class="container">
                ...
                <div class="row">
						<div class="team-heading">
							...
							<p>Student-lead development team.</p>
						</div>
