			...
			<div class="container">
				<div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
							<h1 class="text-center"><span>Thank you!</span></h1>
							<h5 class ="text-center">We will respond to your request shortly in a meantime.</h5>
                            <p class="lead text-center">
                            <?php
                            $input1 = $_POST ['name2'];
							$input2 = $_POST ['email2'];
							$input3 = $_POST ['message2'];
                            $conn = new mysqli ('localhost','tan jo yi', '12345', 'librarysystem') or die("unable to connect");
                            $sql="INSERT INTO feedback (name,email,message) VALUES ('$input1','$input2','$input3')";
                            $query=mysqli_query($conn,$sql);
							echo "<p>Name : $input1</p>";
							echo "<br>";
							echo "<p>Email : <i>$input2</i></p>";
							echo "<br>";
							echo "<p>Message : <i>$input3</i></p>";
							echo "<br>";
							?>
							<br>
							<input type="submit"  value="Done" style="font-size:15pt;color:white;background-color:#E55451;border:2px solid #E55451;padding:6px"> </p>
						</div>
					</div>
				</div>
			</div>
