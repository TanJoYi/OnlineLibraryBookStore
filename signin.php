			...
			<div class="container">
				<div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
							...
							<h5 class ="text-center">Welcome to <i>Tee Time</i>, your faithful reading companion!</h5>
                            <p class="lead text-center">
                                    ...
                                    <br>
                                    <input type="submit"  value="Login" style="font-size:15pt;color:white;background-color:#E55451;border:2px solid #E55451;padding:6px">
                                </form>
